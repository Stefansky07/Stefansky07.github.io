---
title: Tea加密
date: '2025-09-26 09:18:52'
updated: '2026-04-22 09:17:38'
permalink: /post/tea-encryption-z181fsh.html
comments: true
toc: true
---
...
![image](http://127.0.0.1:6051/assets/image-20250926101004-eyla6h3.png)
...
![image](http://127.0.0.1:6051/assets/image-20250926101124-yvxwsd9.png)
...
![image](http://127.0.0.1:6051/assets/image-20250926101253-50tqcly.png)

进入main_0函数，经分析可知"input key"阶段进行的是TEA加密，并给出了key秘钥的内容(此处笔误写成了RC4)

![image](http://127.0.0.1:6051/assets/image-20250926101304-e9zmfvk.png)

查看栈段的调用发现v7和v8是连着的

![image](http://127.0.0.1:6051/assets/image-20250926101312-kwl5shb.png)
...
![image](http://127.0.0.1:6051/assets/image-20250926101338-t5g157o.png)

发现是一堆未识别出的数据

![image](http://127.0.0.1:6051/assets/image-20250926101347-xqcahdu.png)

打断点进入调试模式

![image](http://127.0.0.1:6051/assets/image-20250926101354-rx7dmdo.png)

步进运行程序将loc_0041D000地址的数据分析为指令，再在loc_0041D000处按P将其分析为函数，分析伪代码可知该函数为RC4加密

![image](http://127.0.0.1:6051/assets/image-20250926101405-coe2zr1.png)
...
![image](http://127.0.0.1:6051/assets/image-20250926101418-bd08cll.png)
