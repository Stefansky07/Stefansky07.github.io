...
![image](https://raw.githubusercontent.com/Stefansky07/Stefansky07.github.io/hexo-src/source/img/siyuan/1-20260519225738-mcvahzx.jpg)
...
预处理器根据 # 开头的命令修改原始的 c 程序。比如根据 #include<stdio.h> 命令把头文件 stdio.h 的内容直接插入到程序文件中。

**编译阶段**

汇编语言程序中的每条语句都以一种标准的文本格式确切地描述一条低级机器语言指令。

**汇编阶段**

汇编器将hello.s翻译成机器语言指令，把这些指令打包成一种叫可重定向目标程序的格式，并将结果保存至目标文件hello.o中。
...
![](https://raw.githubusercontent.com/Stefansky07/Stefansky07.github.io/hexo-src/source/img/siyuan/wps1-20250309124757-ilcw3gx.jpg)
...
![](https://raw.githubusercontent.com/Stefansky07/Stefansky07.github.io/hexo-src/source/img/siyuan/wps2-20250309124757-ze2t6mw.jpg)
...
2.  CPU上，几十MB，比 L2 快 5 倍；L2 通过特殊的总线与 CPU 相连，几百 MB<sub>几 GB，比主存快 5</sub>10 倍
3.  把可能经常访问的数据放到高速缓存中
4.  7层，用上一层做下一层的高速缓存
5.  进程、虚拟内存、文件
