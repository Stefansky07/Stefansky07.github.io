...
![image](/img/from-report/Tea加密/image-20250926101004-eyla6h3-4ba60a19.png)
...
![image](/img/from-report/Tea加密/image-20250926101124-yvxwsd9-3dbfc122.png)
...
![image](/img/from-report/Tea加密/image-20250926101253-50tqcly-2d61d56d.png)

进入main_0函数，经分析可知"input key"阶段进行的是TEA加密，并给出了key秘钥的内容(此处笔误写成了RC4)

![image](/img/from-report/Tea加密/image-20250926101304-e9zmfvk-d11fbb6c.png)

查看栈段的调用发现v7和v8是连着的

![image](/img/from-report/Tea加密/image-20250926101312-kwl5shb-3ad2f895.png)
...
![image](/img/from-report/Tea加密/image-20250926101338-t5g157o-8c357e7c.png)

发现是一堆未识别出的数据

![image](/img/from-report/Tea加密/image-20250926101347-xqcahdu-83143fd8.png)

打断点进入调试模式

![image](/img/from-report/Tea加密/image-20250926101354-rx7dmdo-59064cba.png)

步进运行程序将loc_0041D000地址的数据分析为指令，再在loc_0041D000处按P将其分析为函数，分析伪代码可知该函数为RC4加密

![image](/img/from-report/Tea加密/image-20250926101405-coe2zr1-df02bb52.png)
...
![image](/img/from-report/Tea加密/image-20250926101418-bd08cll-9c2a593e.png)
